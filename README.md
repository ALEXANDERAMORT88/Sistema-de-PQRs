...
- Evaluar si es necesario contar con un asesor especializado por cada tipología de PQR.
- Contar con un área específica encargada de los casos que superen los tiempos de resolución establecidos.
- Envío de correos automáticos cuando un caso exceda los tiempos de respuesta.
- Habilitar canales de comunicación con los clientes para solicitar información adicional cuando sea necesario.
...
- Facilitar la comunicación entre la empresa y los clientes.
- Generar información que apoye la toma de decisiones y la mejora del servicio.
